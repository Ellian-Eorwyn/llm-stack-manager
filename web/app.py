...
CONFIG_FIELDS = [
    ...
    {"section": "Shared Backend 2", "key": "CHAT2_CACHE_TYPE_K",          "label": "KV Cache Key Type",      "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    ...
    {"section": "Shared Backend", "key": "CHAT_CACHE_TYPE_K",          "label": "KV Cache Key Type",      "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    ...
    {"section": "Embedding",   "key": "EMBED_CACHE_TYPE_K",         "label": "KV Cache Key Type",    "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    {"section": "Embedding",   "key": "EMBED_CACHE_TYPE_V",         "label": "KV Cache Value Type",  "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    ...
    {"section": "Embedding 2", "key": "EMBED2_CACHE_TYPE_K",        "label": "KV Cache Key Type",    "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    {"section": "Embedding 2", "key": "EMBED2_CACHE_TYPE_V",        "label": "KV Cache Value Type",  "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    ...
    {"section": "Reranker",    "key": "RERANK_CACHE_TYPE_K",        "label": "KV Cache Key Type",    "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    {"section": "Reranker",    "key": "RERANK_CACHE_TYPE_V",        "label": "KV Cache Value Type",  "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
    ...
    {"section": "OCR",        "key": "OCR_CACHE_TYPE_K",         "label": "KV Cache Key Type",    "type": "select", "options": ["q8_0", "f16", "f32", "q4_0", "q4_1", "iq4_nl"]},
