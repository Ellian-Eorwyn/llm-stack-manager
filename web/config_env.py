...
def normalize_env_keys(env: dict) -> dict:
    ...
    normalized.setdefault("CHAT_LORA_PATHS", "")
    normalized.setdefault("CHAT_LORA_SCALES", "")
    normalized.setdefault("CHAT_LORA_INIT_WITHOUT_APPLY", "on")
    normalized.setdefault("CHAT_TEMPLATE_ID", "")
    normalized.setdefault("CHAT_PRESERVE_THINKING", "on")
    normalized.setdefault("CHAT_REASONING_EFFORT", "")
    ...
    normalized.setdefault("LLM_B_LORA_PATHS", "")
    normalized.setdefault("LLM_B_LORA_SCALES", "")
    normalized.setdefault("LLM_B_LORA_INIT_WITHOUT_APPLY", "on")
    ...
    normalized.setdefault("THINK2_MODEL_NAME", "think2")
    normalized.setdefault("NOTHINK2_MODEL_NAME", "chat2")
    ...
    normalized.setdefault("CODE_REASONING_EFFORT", "medium")
    ...
    normalized.setdefault("TASK_LORA_PATHS", "")
    normalized.setdefault("TASK_LORA_SCALES", "")
    normalized.setdefault("TASK_LORA_INIT_WITHOUT_APPLY", "on")
    normalized.setdefault("TASK_CHAT_TEMPLATE_ID", "")
    normalized.setdefault("TASK_REASONING_EFFORT", "low")
