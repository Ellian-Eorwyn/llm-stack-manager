...
CONFIG_FIELDS = [
    ...
    {"section": "Apple Silicon (MLX)", "key": "MLX_DIARIZATION_MODEL_PATH", "label": "Diarization Model", "type": "path", "hint": "Nemotron 3 Diarization, used when a request sends diarize=true. Blank disables speaker labels"},
    {"section": "Apple Silicon (MLX)", "key": "MLX_DIARIZATION_THRESHOLD",  "label": "Speaker Threshold", "type": "number", "hint": "Per-frame activity probability that counts as speaking. Lower finds quiet speakers, and more crosstalk"},
    {"section": "Apple Silicon (MLX)", "key": "MLX_VOICEPRINT_MODEL_PATH",  "label": "Voiceprint Model",  "type": "path",   "hint": "WeSpeaker ResNet34; names diarized speakers from enrolled voice profiles. Blank disables naming"},
    {"section": "Apple Silicon (MLX)", "key": "MLX_VOICEPRINT_PROFILES",    "label": "Voice Profiles",    "type": "path",   "hint": "Built by scripts/enroll-voiceprints.py; re-read when it changes, no restart needed"},
    {"section": "Apple Silicon (MLX)", "key": "MLX_VOICEPRINT_THRESHOLD",   "label": "Name Threshold",    "type": "number", "hint": "Similarity a voice needs to be named. Blank uses the one enrollment's evaluation chose"},
    {"section": "Apple Silicon (MLX)", "key": "MLX_VOICEPRINT_MARGIN",      "label": "Name Margin",       "type": "number", "hint": "How far the best match must beat the next-best person; similar voices then stay unnamed"},
...
RESTART_HINTS = {
    ...
    "MLX_DIARIZATION_MODEL_PATH":   ["transcript-backend"],
    "MLX_DIARIZATION_THRESHOLD":    ["transcript-backend"],
    "MLX_VOICEPRINT_MODEL_PATH":    ["transcript-backend"],
    "MLX_VOICEPRINT_PROFILES":      ["transcript-backend"],
    "MLX_VOICEPRINT_THRESHOLD":     ["transcript-backend"],
    "MLX_VOICEPRINT_MARGIN":        ["transcript-backend"],
